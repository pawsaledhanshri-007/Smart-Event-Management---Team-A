...
-- Implements the Database Design Specification (Step 2)
-- Run this against a fresh database, e.g.:
--   psql -U event_admin -d event_management -f schema.sql
-- =====================================================================
...
-- composite index used for the venue double-booking check
...
-- Vector similarity index — add AFTER you have real data loaded.
-- HNSW is the modern default (pgvector >= 0.5.0); IVFFlat is the fallback
-- for older pgvector versions.
